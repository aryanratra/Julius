...
public class MyFrame extends JFrame implements ActionListener
{
	...
	JButton en_button, de_button, ok_button, cancel_button, submit_button;
	File en_file, src_file, dec_file;
	JLabel title, copyright, keyLabel, addLabel; 
	...
	public void ComponentCreator()
	{
		...
		en_button.setToolTipText("<html>Convert your files into a secret code using different <br>encrypting algorithms like AES, RSA, Vigenère Cipher etc.");
...
//		CeasarButton.setBackground(new Color(40,40,40));
		...
		keyField.setBounds(300, 50, 400, 25);
		keyField.setText("Username");
		
		addField = new JTextField();
		addField.setBounds(300, 180, 400, 25);
...
//		String address="D:\\En_Earth_Intro.mp4";
//		en_file = new File(address);
//		new DES();
//		try {
...
//		}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(AESButton.isSelected()||DESButton.isSelected()||RSAButton.isSelected()||VignereButton.isSelected()||HashButton.isSelected()||CeasarButton.isSelected())
		{
		...
		{
			str_key=keyField.getText();
			str_add=addField.getText();
			System.out.println(str_key);
